...
function draw() {
  ...
  text("Score " + Score, width/2-150,height/2+150);
  text("Highest Socre: "+sessionStorage["HighestScore"],width/2-400,height/2+150)
...
function createclouds() {
  if (frameCount % 40 === 0) {
    cloud = createSprite(450, height-120, 50, 10);
    cloud.velocityX = -8;
...
function createobstacles() {
  if (frameCount % 40 === 0) {
    obstacles = createSprite(width/2+800,height-70, 10, 100);
